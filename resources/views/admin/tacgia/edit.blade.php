                                        ...
                                        <div class="all-form-element-inner">
                                            <form action="" method="post">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <label class="login2 pull-right pull-right-pro">Mã tác giả</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" name="matg" value="{{ $tacgia->matg }}" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control" name="tentg" value="{{ $tacgia->tentg }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="data-custon-pick" id="data_1">
                                                                <div class="input-group date">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ngaysinh" value="{{ $tacgia->ngaysinh }}" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
